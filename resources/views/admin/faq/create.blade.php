        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal" method="post" action="{{url('/admin/faq')}}" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-11 {{ $errors->has('question') ? ' has-error' : '' }}">
                                    <input type="text" name="question" class="form-control" id="question" placeholder="question" value="{{ old('question') }}" required autofocus>
                                    @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-11 {{ $errors->has('answer') ? ' has-error' : '' }}">
                                    <div class="box-body pad">
                                        <textarea name="answer" class="form-control" placeholder="answer" id="editor1">{{ old('answer') }}</textarea>
