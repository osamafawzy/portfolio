        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal" method="post" action="{{url('/admin/team/'.$team->id)}}" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5 {{ $errors->has('name') ? ' has-error' : '' }}">
                                    <input type="text" name="name" class="form-control" id="name" placeholder="Name" value="{{$team->name}}" required autofocus>
                                    @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5 {{ $errors->has('position') ? ' has-error' : '' }}">
                                    <input type="text" name="position" class="form-control" id="position" placeholder="Position" value="{{$team->position}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5 {{ $errors->has('facebook') ? ' has-error' : '' }}">
                                        <input type="url" name="facebook" class="form-control" id="facebook" placeholder="Facebook" value="{{$team->facebook}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5 {{ $errors->has('twitter') ? ' has-error' : '' }}">
                                        <input type="url" name="twitter" class="form-control" id="twitter" placeholder="Twitter" value="{{$team->twitter}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5 {{ $errors->has('google') ? ' has-error' : '' }}">
                                        <input type="url" name="google" class="form-control" id="google" placeholder="Google" value="{{$team->google}}">
