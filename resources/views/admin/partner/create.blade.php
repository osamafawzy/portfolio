        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal" method="post" action="{{url('/admin/partner')}}" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 {{ $errors->has('link') ? ' has-error' : '' }}">
                                    <input type="url" name="link" class="form-control" id="link" placeholder="Link" value="{{ old('link') }}" required autofocus>
                                    @if ($errors->has('link'))
                                        <span class="help-block">
